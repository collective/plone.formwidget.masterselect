...
class IMasterSelectDemo(model.Schema):
    ...
    masterField = MasterSelectField(
        title=_("MasterField"),
        description=_(
            "This field controls the vocabulary of slaveField1,"
    ...
    slaveField1 = schema.Set(
        title=_("SlaveField1"),
        description=_(
            "This field's vocabulary is controlled by the value "
    ...
    slaveField2 = schema.Choice(
        title=_("SlaveField2"),
        description=_(
            "This field's visibility is controlled by the value "
    ...
    slaveField3 = schema.Bool(
        title=_("SlaveField3"),
        description=_(
            "This field's availability is controlled by the value "
    ...
    masterField2 = MasterSelectField(
        title=_("MasterField2"),
        description=_(
            "This field controls the vocabulary of "
            "slaveMasterField, the available values in "
            "slaveMasterField will be the 5 letters after the "
            "selected letter. It also controls the current value "
            "of the field SlaveValueField, which contains the "
            "ROT13 transformed value of the selection."
        ),
        values=("a", "b", "c", "d", "e", "f"),
        slave_fields=(
    ...
    slaveMasterField = MasterSelectField(
        title=_("SlaveMasterField"),
        description=_(
            "This field's vocabulary is controlled by the value "
            "selected in masterField2. The values available here "
            "will be the 5 letters after the selected letter. "
            "This field also controls the visibility of "
            "slaveField4. If the values c or g are selected "
            "slaveField4 will be hidden. Only the input field will "
            "be hidden while the title and description will remain "
            "visible"
        ),
        values=(1, 2, 3, 4, 5, 6),
        slave_fields=(
    ...
    slaveField4 = schema.Choice(
        ...
        description=_(
            "This field's visibility is controlled by the value "
            "selected in slaveMasterField. It will become "
            "invisible when the values c or g are selected. Notice "
            "only the form field disappears while the label and "
            "description remain (siblings set to False"
        ),
        values=("10", "20", "30", "40", "50"),
        required=False,
    )
    ...
    slaveValueField = schema.TextLine(
        title=_("SlaveValueField"),
        description=_(
            "This field's value is controlled by the value "
    ...
    masterField3 = MasterSelectField(
        title=_("MasterField3"),
        description=_(
            "This field controls the visibility of slaveField5. "
    ...
    masterBoolean = MasterSelectBoolField(
        title=_("MasterBoolean"),
        description=_(
            "This field controls the visibility of slaveField6, "
    ...
    masterField4 = MasterSelectField(
        title=_("MasterField 4"),
        description=_(
            "This field controls the vocabulary of slaveField7."
            "The selected value becomes the value of slaveField7."
        ),
        values=("ok", "nok"),
        slave_fields=(
            {
